...
class GranularBall:
    """ class of the granular ball
        data 格式 [{attribute1,attribute2,...,attributeN},{label},{index}]
    """
...
class GBList:
    ...
    def get_data(self):
        ...
        return np.vstack(list_data)  # 变成列关系
